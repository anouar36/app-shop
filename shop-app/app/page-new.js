...
const paymentMethods = [
  { id: 1, name: "Credit Card", icon: "/placeholder.jpg" },
  { id: 2, name: "PayPal", icon: "/placeholder.jpg" },
  { id: 3, name: "Apple Pay", icon: "/placeholder.jpg" },
  { id: 4, name: "Google Pay", icon: "/placeholder.jpg" }
];
      ...
      <header className="border-b border-border sticky top-0 z-50 bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#" className="text-sm font-medium hover:underline underline-offset-4">Products</a>
            <a href="#" className="text-sm font-medium hover:underline underline-offset-4">Categories</a>
            <a href="#" className="text-sm font-medium hover:underline underline-offset-4">Sale</a>
                ...
                <CarouselItem key={slide.id}>
                  <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
                    ...
                    <div className="w-full h-full bg-muted flex items-center justify-center">
                      <div className="text-2xl text-muted-foreground">Hero Image {slide.id}</div>
                    </div>
                    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center text-white p-6">
                      ...
                      <Button size="lg" className="bg-primary hover:bg-primary/90">{slide.buttonText}</Button>
                    </div>
                  </div>
                </CarouselItem>
              ))}
          ...
          <div className="container mx-auto px-4">
            <div className="rounded-xl bg-gradient-to-r from-primary/80 to-primary p-6 md:p-12 text-white overflow-hidden relative">
              <div className="max-w-lg">
                ...
                <Button variant="secondary" size="lg" className="text-primary">Shop the Sale</Button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Featured</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Sale</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Returns & Exchanges</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Shipping Information</a></li>
              </ul>
            </div>
            <div>
