    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <main>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { name: "Electronics", emoji: "📱", color: "from-blue-400 to-blue-600", count: `${products.filter(p => p.category?.name?.toLowerCase() === 'electronics').length}+ Items` },
                { name: "Fashion", emoji: "👕", color: "from-pink-400 to-pink-600", count: `${products.filter(p => p.category?.name?.toLowerCase() === 'clothing').length}+ Items` },
                { name: "Shoes", emoji: "👟", color: "from-green-400 to-green-600", count: `${products.filter(p => p.category?.name?.toLowerCase() === 'shoes').length}+ Items` },
                { name: "Accessories", emoji: "👜", color: "from-purple-400 to-purple-600", count: `${products.filter(p => p.category?.name?.toLowerCase() === 'accessories').length}+ Items` }
              ].map((category, index) => (
          ...
          {loading ? (
            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="clothing" className="mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {getFilteredProducts("clothing").map(product => (
                    <ProductCard key={product.id} product={product} />
                  ))}
                </div>
              </TabsContent>
              ...
              <TabsContent value="shoes" className="mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {getFilteredProducts("shoes").map(product => (
                    <ProductCard key={product.id} product={product} />
                  ))}
                </div>
              </TabsContent>
              ...
              <TabsContent value="electronics" className="mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {getFilteredProducts("electronics").map(product => (
                    <ProductCard key={product.id} product={product} />
                  ))}
                </div>
              </TabsContent>
              ...
              <TabsContent value="accessories" className="mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {getFilteredProducts("accessories").map(product => (
                    <ProductCard key={product.id} product={product} />
                  ))}
                </div>
              </TabsContent>
        ...
        <section className="py-12 bg-primary/10">
          <div className="container mx-auto px-4">
            <div className="rounded-xl bg-gradient-to-r from-primary/80 to-primary p-6 md:p-12 text-white overflow-hidden relative">
              ...
              {paymentMethods.map(method => (
                <Card key={method.id} className="bg-background hover:shadow-md transition-shadow">
                  <CardContent className="flex flex-col items-center justify-center p-4">
                    <div className="w-12 h-12 rounded-full bg-muted flex items-center justify-center mb-4 overflow-hidden">
                      <img src={method.icon} alt={`${method.name} icon`} className="w-full h-full object-cover" onError={(e) => e.target.src = "/payment/placeholder.jpg"} />
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#products-section" className="text-sm hover:underline text-muted-foreground">All Products</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">New Arrivals</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Sale Items</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Support</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Contact Us</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">FAQ</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Shipping Info</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">Company</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">About Us</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Careers</a></li>
                <li><a href="#" className="text-sm hover:underline text-muted-foreground">Press</a></li>
              </ul>
            </div>
          </div>
